...
MATERIALS={
    ...
    'window':(.20,.36,.45,1),'glass':(.24,.43,.52,1),'door':(.23,.16,.10,1),
    'brick':(.43,.24,.18,1),'stucco':(.70,.66,.56,1),'concrete':(.50,.50,.48,1),
    'stone':(.58,.56,.50,1),'metal':(.28,.30,.31,1),'trim':(.72,.70,.64,1),
    'balcony':(.47,.45,.41,1),'bark':(.27,.18,.10,1),
